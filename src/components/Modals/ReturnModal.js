                ...
                <Row justify="space-between">
                    <Col span={10}>
                        ...
                        >
                            ...
                            <Form.Item name="mileage" label="Used Mileage" className='font-semibold' rules={[
                                {
                                    required: true,
                    ...
                    <Col span={12}>
                        {selected ?
                            <List size="small" bordered className='bg-sky-100'>
                                <List.Item><span className='font-bold'>{selected.name}</span></List.Item>
                                <List.Item><span className='font-bold'>Bookd for:</span> {selected.bookingsDays} Days</List.Item>
                                <List.Item><span className='font-bold'>Period:</span> {selected.bookingsDates?moment(selected.bookingsDates[0]).format('l') + "-" + moment(selected.bookingsDates[1]).format('l'):"Not Found"}</List.Item>
                                <List.Item><span className='font-bold'>Mileage:</span> {selected.mileage || 0 }</List.Item>
                            </List> : null
                        }
                    </Col>
                </Row>
