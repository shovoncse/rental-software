  ...
  return (
    <>
      <Row justify="center">
        ...
        <Col xs={20} sm={20} md={16} lg={16} xl={16}>
          <ProductTable
            setBookModal={(val) => setBookModalVisible(val)}
            setReturnModal={(val) => setReturnModalVisible(val)}
          />
        </Col>
        <Col span={24}>
      ...
      <BookModal
        ...
        setBookModal={(val) => setBookModalVisible(val)}
        setConfirmModal={(val) => setBookConfirmModalVisible(val)}
      />

      {/* book confirm */}
      <BookConfirmModal
        visible={bookConfirmModalVisible}
        setConfirmModal={(val) => setBookConfirmModalVisible(val)}
        setBookModal={(val) => setBookModalVisible(val)}
      />
      ...
      <ReturnModal
        ...
        setReturnModal={(val) => setReturnModalVisible(val)}
        setConfirmModal={(val) => setReturnConfirmModalVisible(val)}
      />
